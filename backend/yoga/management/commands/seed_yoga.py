...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        videos_data = [
            # ── WEIGHT LOSS ──────────────────────────────────────────────────
            {
                "title": "Power Yoga Break | Yoga For Weight Loss",
                "youtube_id": "6rh6pVGTqRU",
                "category": "weight_loss",
                "duration_mins": 18,
                "instructor": "Yoga With Adriene",
                "difficulty": "intermediate",
                "thumbnail_url": "https://img.youtube.com/vi/6rh6pVGTqRU/hqdefault.jpg",
                "calorie_burn": 220,
                "flexibility": "Medium",
                "relaxation": "Low",
                "strength": "High",
            ...
            {
                "title": "Yoga For Weight Loss | Healthy Energy Flow",
                "youtube_id": "lMWOrDH694c",
                "category": "weight_loss",
                "duration_mins": 36,
                "instructor": "Yoga With Adriene",
                "difficulty": "intermediate",
                "thumbnail_url": "https://img.youtube.com/vi/lMWOrDH694c/hqdefault.jpg",
                "calorie_burn": 320,
                "flexibility": "High",
                "relaxation": "Low",
                "strength": "High",
            ...
            },
            {
                ...
                "youtube_id": "BPobdbmzY9o",
                "category": "belly_fat",
                "duration_mins": 20,
                "instructor": "Yoga With Adriene",
                "difficulty": "intermediate",
                "thumbnail_url": "https://img.youtube.com/vi/BPobdbmzY9o/hqdefault.jpg",
                "calorie_burn": 140,
                "flexibility": "Medium",
                "relaxation": "Low",
                "strength": "High",
            ...
            {
                "title": "25 Min Power Yoga for Strength Workout (FULL BODY)",
                "youtube_id": "RTBg-TbPCyw",
                "category": "weight_gain",
                "duration_mins": 25,
                "instructor": "Sean Vigue Fitness",
                "difficulty": "advanced",
                "thumbnail_url": "https://img.youtube.com/vi/RTBg-TbPCyw/hqdefault.jpg",
                "calorie_burn": 280,
                "flexibility": "High",
                "relaxation": "Low",
                "strength": "High",
